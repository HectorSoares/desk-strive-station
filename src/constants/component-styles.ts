...
export function createComponentStyles(theme: AppColorPalette) {
  return StyleSheet.create({
    ...
    taskName: { color: theme.ink, fontSize: 13, fontWeight: '500', marginBottom: spacing[4] },
    taskDesc: { color: theme.midGray, fontSize: 11 },
    taskTag: { fontSize: 10, fontWeight: "700", color: "#10b981", marginLeft: 8 },
